...
instructor: ["Nelly Sélem", "César Aguilar", "Shaday Guerrero"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Marisol Navarro", "José Abel Lovaco", "Andrés Arredondo","Paulnia Mayel", "Diana Oaxaca","Francisxo max", "Rafael Pérez", "Anton Pashkov"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
